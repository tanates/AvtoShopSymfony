 ...
 */
class getAvtoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AvtoRepository' shared autowired service.
     *
     * @return \App\Repository\AvtoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AvtoRepository.php';

        return $container->privates['App\\Repository\\AvtoRepository'] = new \App\Repository\AvtoRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
